...
namespace SpiritStorm.Dialogue.Editor
{
    public class DialogueEditor : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            nodeStyle.normal.background = (Texture2D)EditorGUIUtility.Load("node0");
        ...
        private void DrawNode(DialogueNode node)
        {
            ...
            node.SetPlayerSpeaking(EditorGUILayout.Toggle("Is Player Speaking", node.IsPlayerSpeaking()));
        ...
        private void DrawConnections(DialogueNode node)
        {
            ...
            foreach (DialogueNode childNode in selectedDialogue.GetAllChildren(node))
            {
                ...
                Handles.DrawBezier(
                    ...
                    startPosition + controlPointOffest, endPosition - controlPointOffest, 
                    Color.white, null, 4f);
            }
        }
